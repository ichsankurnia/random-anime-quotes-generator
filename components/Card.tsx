        ...
        <>
            <div className='flex flex-col items-start min-w-full md:min-w-[30rem] 2xl:min-w-[35rem] max-w-3xl'>
                <div className="backdrop-blur-sm bg-white/30 p-8 rounded-tl-xl rounded-br-xl text-base 2xl:text-lg w-full">
                    ...
                    <div className="flex flex-col item-center sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 font-normal">
                        ...
                        >
                            Tweet{' '}<i className="fa-brands fa-twitter hover-rotate"></i>
                        </Link>
                    </div>
                </div>
                <button type="button" className="mt-3 inline-block px-6 py-3 font-medium text-sm text-center bg-gradient-to-tl from-blue-600 to-cyan-400 align-middle transition-all rounded-lg cursor-pointer leading-pro ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs text-white hover:opacity-80 duration-300"
                    onClick={() => {
                        setLoading(true)
                        getQuote()
                    }} >
